...
public class Main implements Serializable {
    ...
    public static void main(String[] args) throws RemoteException {
        ...
        try {
            ...
            Cliente cliente=new Cliente(controlador.getCliente().getNombreCliente(),controlador.getCliente().getDireccionCliente(),controlador.getCliente().getTelefono(),controlador.getCliente().getTipoCuenta());
            Pedido pedido=new Pedido(controlador.getPedido().getProductoNombre(),controlador.getPedido().getCodigo(),controlador.getPedido().getCantidad());

            Usuario usuario=new Usuario(controlador.getUsuario().getId(),controlador.getUsuario().getContraseña());
